                            ...
                            if (line[5].isnumeric()):
                                ...
                                if (line[6].isnumeric()):
                                    ...
                                    if (line[7].isnumeric()):
                                        ...
                                        l=l+1
                                        d=d+1
print('00000'+str(d)+t+('0'*(74-len(t))),file=fout)
print('TRANS0'+"{:04d}".format(s)+'0'*70,file=fout)
sys.exit(0)
